...
window.webcam = {
	...
	swf_url: 'resources/asset/js/forIE/webcam.swf?version='+ (new Date).getTime() , // URI to webcam.swf movie (defaults to cwd)
	shutter_url: 'resources/asset/js/forIE/shutter.mp3?version='+ (new Date).getTime(), // URI to shutter.mp3 sound
	...
	get_html: function(width, height, server_width, server_height) {
        var swf_url = 'resources/asset/js/forIE/webcam.swf?version='+ (new Date).getTime();
		...
		if (this.ie) {
			html += '<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="'+this.protocol+'://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0" width="'+width+'" height="'+height+'" id="webcam_movie" name="webcam_movie" align="middle"><param name="allowScriptAccess" value="always" /><param name="allowFullScreen" value="false" /><param name="movie" value="'+swf_url+'" /><param name="loop" value="false" /><param name="menu" value="false" /><param name="quality" value="best" /><param name="bgcolor" value="#ffffff" /><param name="flashvars" value="'+flashvars+'"/></object>';
		}
		else {
	...
	set_shutter_sound: function(enabled, url) {
		...
		this.shutter_url = url ? url : 'resources/asset/js/forIE/shutter.mp3?version='+ (new Date).getTime();
	},
