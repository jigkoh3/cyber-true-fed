...
window.webcam = {
	...
	swf_url: 'js/webcam/webcam.swf?version='+ (new Date).getTime() , // URI to webcam.swf movie (defaults to cwd)
	shutter_url: 'js/webcam/shutter.mp3?version='+ (new Date).getTime(), // URI to shutter.mp3 sound
	...
	get_html: function(width, height, server_width, server_height) {
        var swf_url = 'js/forIE/webcam.swf?version='+ (new Date).getTime();
	...
	set_shutter_sound: function(enabled, url) {
		...
		this.shutter_url = url ? url : 'js/webcam/shutter.mp3?version='+ (new Date).getTime();
	},
