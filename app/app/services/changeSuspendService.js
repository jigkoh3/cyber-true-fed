smartApp.service('ChangeSuspendService', function($routeParams, $timeout, SystemService) {
    ...
    this.getSIMData = function(msisdn, callback) {
        ...
        if (!demo) {
            var target = '/aftersales/tmv/suspend/validatesuspend?msisdn=' + msisdn;
    ...
    this.submitChangeSuspend = function(payload, fnCallback) {
        var request = {
            ...
            'order': {
                ...
                "sale-agent": {
                    ...
                    'partner-code': (payload.saleAgent["partnerCodes"].length > 0 ? payload.saleAgent["partnerCodes"][0] : payload.saleAgent["ssoPartnerPrincipal"]['employeeId']),
