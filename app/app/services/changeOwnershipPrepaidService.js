smartApp.service('changeOwnershipPrepaidService', function($filter, SystemService, $routeParams) {
    ...
    return {
        ...
        validateChangeOwnershipPrepaidCallback: function(msisdn, fnCallback) {
            var res = {};

            validateChangeOwnershipPrepaidAPI(msisdn, function(result) {
                    ...
                    if (result.status) {
                        ...
                        if (priceplan["account-category"], priceplan["company-code"], priceplan["mobile-servicetype"]) {
                            ...
                            AccountSubtypeAPI(priceplan["account-category"], priceplan["company-code"], priceplan["mobile-servicetype"], function(subtype) {
                                if (subtype.data["response-data"]) {
                                    ...
                                    console.debug("changeOwnershipPrepaidService : account-sub-type not response data");
                                }
                            ...
                            console.debug("changeOwnershipPrepaidService : account-category,company-code,mobile-servicetype is undefine!");
                        }
                        ...
                        setTimeout(function() {
                            SystemService.showAlert({
                                ...
                                "en-message": "",
                                "th-message": "",
                                "technical-message": "validateChangeOwnershipPrepaidAPI"
                            });
                        }, 1000);
                    }
