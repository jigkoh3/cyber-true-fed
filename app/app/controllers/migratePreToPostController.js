...
smartApp.controller('MigratePreToPostController', function ($scope, SystemService, $routeParams, ReasonService) {
    ...
    $scope.init = function () {
        ...
        SystemService.get("0689100006", function (result) {
            ...
            $scope.data.header["producttype"] = 'ทรูมูฟเอช เติมเงิน';
            $scope.isReadCardSuccess = false;
        });
    ...
    $scope.SetCardValue3 = function (result) {
        ...
        //$('.disebleForm').disabled(true);       
           
        $('#citizenID3').val($scope.cardInfo3.CitizenID);        
        $('#prefixTH3').val("OTHER");
        $scope.newOwner.prefixTH = "OTHER";
