...
smartApp.controller('MigratePreToPostController', function(
    ...
    $scope.readCardError = function(msg) {
        ...
        SystemService.showAlert({
            ...
            "en-message": msg,
            "th-message": msg,
            "technical-message": "migratePreToPostController"
        });
    };
    ...
    $scope.callSalePricePlanList = function() {
        if ($scope.isVerify) {
            ...
            migratePreToPostService.salePriceplanCallback(target, function(resultGetPriceplan) {
