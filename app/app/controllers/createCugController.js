...
smartApp.controller('CreateCugController', function($scope, $routeParams, CreateCugService, AuthenService, ReasonService, paginationService,
    ValidateMsgService, $filter, SystemService) {
    ...
    $scope.readCardError = function(msg) {
        ...
        SystemService.showAlert({
            ...
            "en-message": msg,
            "th-message": msg,
            "technical-message": "createCugController"
        });
    };
