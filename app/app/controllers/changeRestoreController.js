...
smartApp.controller('ChangeRestoreController', function($scope, $routeParams, AuthenService, ChangeRestoreService, ChangePricePlanService, DeviceService, ReasonService, SystemService) {
    ...
    $scope.divID = 'changeRestoreContent';
    ...
    $scope.statusChangeRestore = 'ACTIVE';
    $scope.statusReason = '';
    ...
    $scope.submit = function() {
        ...
        ChangeRestoreService.submitChangeRestore(data, function(result) {
            console.log(result);
    ...
    $scope.logDataBeforeSubmit = function() {
        ...
        console.log($scope.statusChangeRestore);
    ...
    // var checkIsChangeRestoreSim = function(data) {
    ...
    $scope.onInputSubNo = function() {
        ...
        if ($scope.subNoInput && $scope.subNoInput.length === 10) {
            ...
            ChangeRestoreService.getSIMData($scope.subNoInput, onGetSIMData);
        }
    };
    ...
    $scope.confirmPrint = function() {
        ...
        data['statusChangeRestore'] = $scope.statusChangeRestore;
    ...
    $scope.readCardError = function(msg) {
        ...
        SystemService.showAlert({
            ...
            "en-message": msg,
            "th-message": msg,
            "technical-message": "changeRestoreController"
        });
    };
