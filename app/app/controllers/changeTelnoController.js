smartApp.controller('ChangeTelnoController', function ($scope,SystemService, SaleService, $timeout) {
    ...
    $scope.divID = "changeTelnoContent";
    ...
    $scope.init = function () {
        ...
        $('.toggleactive').bootstrapToggle();
        
    };    
    
    $scope.chToggle = function () {
        
        $('#chkchangtel').change(function () {
            $('#console-event').html('Toggle: ' + $(this).prop('checked'));
            $scope.chkchangtel = $(this).prop('checked');
        })
    };
